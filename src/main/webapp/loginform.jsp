...
<%
	/*
		요청 URL
			localhost/app4/loginform.jsp			- 로그인 메뉴 클릭
			localhost/app4/loginform.jsp?err=fail	- 아이디/비밀번호 오류
			localhost/app4/loginform.jsp?err=disabled	- 탈퇴
			localhost/app4/loginform.jsp?err=req&job=xxx	-로그인 없이 기능 실행
	*/
